...
public class GradientStrokeFont extends GradientFont {
	...
	// endregion Fields
	// region Constructors
	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final Color pColorFrom, final Color pColorTo, final float pStrokeWidth,
		...
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias, pColorFrom.getARGBPackedInt(), pColorTo.getARGBPackedInt(),
				pStrokeWidth, pStrokeColorARGBPackedInt);
	}

	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final Color pColorFrom, final Color pColorTo, final float pStrokeWidth, final Color pStrokeColor) {
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias, pColorFrom.getARGBPackedInt(), pColorTo.getARGBPackedInt(),
				pStrokeWidth, pStrokeColor.getARGBPackedInt());
	}

	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final int pColorFromARGBPackedInt, final int pColorToARGBPackedInt, final float pStrokeWidth,
			final int pStrokeColorARGBPackedInt) {
	...
	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final Color[] pColors, final float pStrokeWidth, final int pStrokeColorARGBPackedInt) {
	...
	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final Color[] pColors, final float pStrokeWidth, final Color pStrokeColor) {
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias, pColors, pStrokeWidth, pStrokeColor.getARGBPackedInt());
	}

	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final int[] pColorsFromARGBPackedInt, final float pStrokeWidth, final int pStrokeColorARGBPackedInt) {
	...
	public GradientStrokeFont(final FontManager pFontManager, final ITexture pTexture, final Typeface pTypeface, final float pSize,
			final boolean pAntiAlias, final int[] pColorsFromARGBPackedInt, final float pStrokeWidth, final Color pStrokeColor) {
